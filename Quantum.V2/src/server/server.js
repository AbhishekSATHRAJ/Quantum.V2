...
const serviceAccount = JSON.parse(readFileSync('./src/server/quantum-c7cbc-firebase-adminsdk-ojw5y-761649b398.json', 'utf8'));
...
const adminAuth = admin.auth();  // Firebase Admin auth instance
const db = admin.firestore();  // Firestore instance for storing user data
...
app.post('/signin', async (req, res) => {
  ...
  try {
    ...
    // Respond with user details, password verification will be handled on the client-side
